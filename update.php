...
<body>
    ...
    <form method="POST" action="update.php?id=<?= $id ?>">
        <div style="background-color: #AFEEEE; margin-left:510px; margin-right:550px; border-radius: 30px; padding-top: 10px; padding-bottom: 10px; margin-top:50px; padding-left: 30px; margin-bottom:40px; ">
    ...
    <div  style="margin-left:645px; border-radius: 30px; padding-left: 30px;">
