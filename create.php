...
<body>
    ...
    <form method="POST" action="create.php">
        <div style="background-color: #AFEEEE; margin-left:520px; margin-right:550px; border-radius: 30px; padding-top: 10px; padding-bottom: 10px; margin-top:50px; padding-left: 30px; margin-bottom:40px; ">
        ...
        <div style="margin-left:660px;margin-bottom:20px;">
            <input type="submit" value="Сохранить" />
        </div>
    </form>
    <div  style="margin-left:655px; border-radius: 30px; padding-left: 30px;">
